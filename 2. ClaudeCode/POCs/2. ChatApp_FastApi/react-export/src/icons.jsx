export function IconHome(props) {
  return (
    <svg width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" {...props}>
...
export function IconSend(props) {
  return (
    <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M3.4 20.6 21.6 12 3.4 3.4 3.3 10l12 2-12 2z" />
    </svg>
  );
}
...
export function IconWallpaper(props) {
  return (
